...
export const WalletIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
);
...
export const StarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
);
...
export const JsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
     <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M3 3h18v18H3V3zm13.6 13.2c0-.8.3-1.3.8-1.6l.6-.4c.1 0 .1-.1 0-.2-.3-.3-1.1-.5-1.9-.5-1.2 0-2.1.6-2.1 2.4 0 1.4.6 2.3 1.8 2.3.8 0 1.4-.3 1.7-.6l-.3-1.2c-.2.2-.5.4-1 .4-.5 0-.8-.2-.8-.7 0-.5 0-.8.1-1 .3.2 1.2 1.1 1.2 1.1zm-5.2-3.5c0 .1 0 .3-.1.4l-1.9 4.8h1.5l.9-2.6h.1l.9 2.6h1.5l-1.9-4.8c-.1-.2-.2-.3-.2-.4h-.8z"></path></svg>
);

export const ExpoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2L2 22h20L12 2zm-1.4 15.2L12 13l1.4 4.2h-2.8z"></path></svg>
);

export const SupabaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12.9 2L4 14h7.1l-1.9 8 8.9-12h-7.1l1.9-8z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
);

export const HtmlIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h20l-2 18-8 3-8-3z"/><path d="M12 19l5.5-2 1.5-12H5l1.5 12z"/></svg>
);
...
export const NpmIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 8h22v7H11v2H7v-2H1z"/><path d="M7 8v7"/><path d="M14 8v7"/><path d="M17 11v4"/><path d="M4 11v4"/><path d="M11 11v1"/><path d="M20 11v4"/></svg>
);

export const TailwindIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11.5 6.5c-3-2-6 1-4 3 1.5 1.5 2.5 1 4-1 2-2.5 5.5-1.5 5.5 1.5 0 2-2 3-4 3-1.5 0-3-1-3-2s2-2 3.5-1c2 1.5 2 3.5 0 5-1.5 1.5-3 1.5-4 1.5"/></svg>
);
...
export const VueIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 19.5h20L12 2zm0 3.5L18.5 17H5.5L12 5.5z"></path></svg>
);

export const NuxtIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l-9.5 16h19L12 2zm0 4l6.5 11h-13L12 6z"></path><circle cx="12" cy="14" r="2"></circle></svg>
);

export const LaravelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const PhpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="12" rx="10" ry="6"></ellipse><path d="M8 12h8"></path><path d="M12 8v8"></path></svg>
);
...
export const ApiIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="12" r="3"></circle><line x1="9" y1="12" x2="15" y2="12"></line></svg>
);
...
export const CloudIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>
);
...
export const LaurelWreathIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" fill="currentColor">
    <path d="M256,0C158.3,0,72.7,56.2,28.2,137.9c-2.3,4.2,0.8,9.4,5.6,9.4c1.6,0,3.2-0.6,4.4-1.7c39.6-36.9,91.8-58.8,148.6-58.8c3.2,0,5.8-2.6,5.8-5.8c0-3.2-2.6-5.8-5.8-5.8C126.9,75.2,71.2,98.6,29.1,138c-2.4,2.3-6.4,0.6-6.4-2.8c0-85.9,89.2-145.2,183.3-145.2s183.3,59.3,183.3,145.2c0,3.3-3.9,5.1-6.4,2.8c-42.1-39.4-97.8-62.8-157.7-62.8c-3.2,0-5.8,2.6-5.8,5.8c0,3.2,2.6,5.8,5.8,5.8c56.8,0,109,21.9,148.6,58.8c1.2,1.1,2.8,1.7,4.4,1.7c4.7,0,7.9-5.1,5.6-9.4C439.3,56.2,353.7,0,256,0z"/>
    <path d="M129.5,417.6c-2.7-2-6.6-1.4-8.6,1.3c-2,2.7-1.4,6.6,1.3,8.6c2.7,2,6.6,1.4,8.6-1.3C132.8,423.5,132.2,419.6,129.5,417.6z M107.1,387.4c-2.9-1.7-6.6-0.7-8.3,2.2c-1.7,2.9-0.7,6.6,2.2,8.3c2.9,1.7,6.6,0.7,8.3-2.2C111,392.8,110,389.1,107.1,387.4z M88.4,354.1c-3.1-1.3-6.6,0.1-7.9,3.2c-1.3,3.1,0.1,6.6,3.2,7.9c3.1,1.3,6.6-0.1,7.9-3.2C92.9,358.9,91.5,355.4,88.4,354.1z M73.7,318.2c-3.2-0.9-6.5,1-7.4,4.2c-0.9,3.2,1,6.5,4.2,7.4c3.2,0.9,6.5-1,7.4-4.2C78.8,322.4,76.9,319.1,73.7,318.2z M63.1,280.6c-3.3-0.5-6.3,1.8-6.8,5.1c-0.5,3.3,1.8,6.3,5.1,6.8c3.3,0.5,6.3-1.8,6.8-5.1C68.7,284.1,66.4,281.1,63.1,280.6z M56.7,241.9c-3.3,0-6,2.7-6,6c0,3.3,2.7,6,6,6c3.3,0,6-2.7,6-6C62.7,244.6,60,241.9,56.7,241.9z"/>
    <path d="M382.5,417.6c-2.7,2-3.3,5.9-1.3,8.6c2,2.7,5.9,3.3,8.6,1.3c2.7-2,3.3-5.9,1.3-8.6C389.1,416.2,385.2,415.6,382.5,417.6z M404.9,387.4c-2.9,1.7-3.9,5.4-2.2,8.3c1.7,2.9,5.4,3.9,8.3,2.2c2.9-1.7,3.9-5.4,2.2-8.3C411.5,386.7,407.8,385.7,404.9,387.4z M423.6,354.1c-3.1,1.3-4.5,4.8-3.2,7.9c1.3,3.1,4.8,4.5,7.9,3.2c3.1-1.3,4.5-4.8,3.2-7.9C429.6,354.2,426.1,352.8,423.6,354.1z M438.3,318.2c-3.2,0.9-5.1,4.2-4.2,7.4c0.9,3.2,4.2,5.1,7.4,4.2c3.2-0.9,5.1-4.2,4.2-7.4C444.8,319.2,441.5,317.3,438.3,318.2z M448.9,280.6c-3.3,0.5-5.6,3.5-5.1,6.8c0.5,3.3,3.5,5.6,6.8,5.1c3.3-0.5,5.6-3.5,5.1-6.8C455.2,282.4,452.2,280.1,448.9,280.6z M455.3,241.9c-3.3,0-6,2.7-6,6c0,3.3,2.7,6,6,6c3.3,0,6-2.7,6-6C62.3,244.6,60,241.9,56.7,241.9z"/>
  </svg>
);
...
export const BrainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6 12h2"/>
    <path d="M3 3l18 18"/>
    <path d="M3 21l18-18" opacity="0"/>
    <path d="M9.17 14.83a4 4 0 0 1 5.66-5.66" opacity="0"/>
    <path d="M9.5 7.5a2.5 2.5 0 0 1 3.5 3.5"/>
  </svg>
);

export const YoutubeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
);

export const InstagramIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
);
