...
const seoTools = [
    ...
    { name: 'Search Console', icon: <SearchIcon className="w-12 h-12 text-[#2eaaf1]" /> },
    { name: 'PageSpeed Insights', icon: <SpeedIcon className="w-12 h-12 text-[#8936ea]" /> },
    { name: 'Technical Audit', icon: <CodeIcon className="w-12 h-12 text-pink-400" /> },
    ...
    { name: 'Local SEO', icon: <MobileIcon className="w-12 h-12 text-[#8936ea]" /> },
];
...
const whatWeDoServices = [
    ...
    },
    {
        ...
        icon: <CodeIcon className="w-10 h-10 text-[#2eaaf1]" />
    },
    {
        title: "Technical SEO",
        desc: "Improving site architecture, speed, and mobile-friendliness for better crawling.",
        icon: <SpeedIcon className="w-10 h-10 text-[#8936ea]" />
    },
    {
    ...
    return (
        <PageWrapper>
            ...
            <section className="relative pt-40 pb-24 bg-slate-950 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex flex-col justify-center">
                ...
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#2eaaf1]/10 rounded-full blur-[100px] pointer-events-none z-0"></div>
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#8936ea]/10 rounded-full blur-[100px] pointer-events-none z-0"></div>
                ...
                <div className="container mx-auto relative z-10 flex flex-col items-center">
                    ...
                    >
                        {/* Pill Badge */}
                        <div className="inline-flex items-center justify-center px-6 py-2 mb-8 rounded-full border border-[#2eaaf1]/30 bg-slate-900/50 backdrop-blur-md">
                            <span className="text-[#2eaaf1] text-xs md:text-sm font-bold tracking-widest uppercase">
                        ...
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-16 tracking-tight leading-none">
                            SEO <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2eaaf1] to-[#8936ea]">Optimization</span>
                        </h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 text-left">
                            ...
                            <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-8 sm:p-10 rounded-3xl hover:border-[#2eaaf1]/30 hover:bg-slate-900/60 transition-all duration-300 group">
                                <h3 className="text-xl md:text-2xl font-bold text-white mb-4 group-hover:text-[#2eaaf1] transition-colors">Data-Driven Strategy</h3>
                            ...
                            <div className="bg-slate-900/40 backdrop-blur-md border border-slate-800 p-8 sm:p-10 rounded-3xl hover:border-[#8936ea]/30 hover:bg-slate-900/60 transition-all duration-300 group">
                                <h3 className="text-xl md:text-2xl font-bold text-white mb-4 group-hover:text-[#8936ea] transition-colors">Sustainable Growth</h3>
                                <p className="text-slate-400 leading-relaxed text-base md:text-lg">
             ...
             <section className="py-12 bg-slate-950">
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                     <motion.div 
                         ...
                         viewport={{ once: true }}
                         transition={{ duration: 0.8 }}
                         className="relative w-full h-[60vh] md:h-[70vh] rounded-3xl overflow-hidden group shadow-2xl shadow-[#2eaaf1]/20"
                     >
                         <img 
            ...
            <section className="py-24 bg-slate-950 relative z-10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {whatWeDoServices.map((service, index) => (
                            <motion.div
                                ...
                                className="group relative bg-slate-900/40 backdrop-blur-sm border border-slate-800 p-8 rounded-2xl hover:border-[#2eaaf1]/50 hover:bg-slate-900/60 hover:shadow-[0_0_30px_rgba(46,170,241,0.1)] transition-all duration-300 flex flex-col"
                            >
                                <div className="mb-6 p-4 rounded-xl bg-slate-950 border border-slate-800 w-fit group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-[#2eaaf1]/20">
                                    {service.icon}
                                </div>
                                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-[#2eaaf1] transition-colors">
                                    {service.title}
                                </h3>
                    ...
                    <div className="mt-16 text-center">
                        <Link to="/contact">
                             <button className="inline-flex items-center gap-2 text-white border-b border-[#2eaaf1] pb-1 hover:text-[#2eaaf1] transition-colors text-lg font-medium group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                             <div className="mb-6 flex items-center gap-3">
                                <div className="h-px w-12 bg-[#2eaaf1]"></div>
                                <span className="text-[#2eaaf1] font-bold uppercase tracking-widest text-sm">Optimization & Results</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-[1.1]">
                                We Optimize With <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2eaaf1] to-[#8936ea]">Precision, Analysis,</span> and Proven Methods
                            </h2>
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#2eaaf1]/20 to-[#8936ea]/20 rounded-2xl transform rotate-3 scale-95 blur-lg opacity-60"></div>
                 ...
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="flex flex-col justify-start">
                            ...
                            >
                                <span className="inline-block py-1 px-3 rounded-full bg-[#2eaaf1]/10 text-[#2eaaf1] text-sm font-bold tracking-widest uppercase mb-6 border border-[#2eaaf1]/20">
                                    Partnerships
                                </span>
                        ...
                        <div>
                            ...
                            >
                                <h3 className="text-2xl font-bold text-white mb-8 border-l-4 border-[#2eaaf1] pl-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {capabilities.map((cap, i) => (
                                        <motion.div 
                                            ...
                                            className="flex items-center gap-3 p-4 bg-slate-950 rounded-xl border border-slate-800 hover:border-[#2eaaf1]/30 transition-colors group"
                                        >
                                            <div className="w-2 h-2 rounded-full bg-[#2eaaf1] group-hover:scale-150 transition-transform"></div>
                            ...
                            <div className="space-y-4">
                                {faqs.map((faq, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <span className="text-xl md:text-2xl font-medium text-slate-200 group-hover:text-[#2eaaf1] transition-colors pr-8">
                                                {faq.q}
                                            </span>
                                            <span className={`transform transition-transform duration-300 ${activeFaq === index ? 'rotate-180' : ''} text-[#2eaaf1] flex-shrink-0 bg-slate-900 p-2 rounded-full`}>
