...
const teamMembers = [
    { 
        name: "Sameer", 
        role: "App Developer & SEO Expert", 
        image: "https://res.cloudinary.com/dow2sbjsp/image/upload/v1766382478/Sameer_if98jm.jpg",
        bio: "Leading the lab's technical vision, Sameer specializes in building high-performance App architectures and advanced SEO strategies that bridge the gap between design and scale."
    },
    { 
        name: "Rehan", 
        role: "Shopify Developer", 
        image: "https://res.cloudinary.com/dow2sbjsp/image/upload/v1767373713/Gemini_Generated_Image_hpnh7khpnh7khpnh_is8eer.png",
        bio: "Expert Shopify developer focused on creating high-conversion e-commerce experiences and seamless platform integrations."
    },
    { 
        name: "Abdullah", 
        role: "WordPress Developer", 
        image: "https://res.cloudinary.com/dow2sbjsp/image/upload/v1767373916/622209bd-6f5e-48af-bf32-1af805bb6901_x5x2zy.jpg",
        bio: "Specializing in the WordPress ecosystem, Abdullah builds robust, scalable themes and custom plugins tailored for performance."
    },
    { 
        name: "Faizan", 
        role: "SEO Specialist", 
        image: "https://res.cloudinary.com/dow2sbjsp/image/upload/v1767374039/Gemini_Generated_Image_ldccgrldccgrldcc_g2f8yo.png",
        bio: "A results-driven SEO strategist, Faizan masters search algorithms to ensure brands dominate rankings and gain organic visibility."
    },
    { 
        name: "Hanzala", 
        role: "Web Developer", 
        image: "https://res.cloudinary.com/dow2sbjsp/image/upload/v1767374179/Screenshot_2026-01-02_215621_aa8zsj.png",
        bio: "A logic-driven web developer who thrives on clean code and modern frameworks, ensuring every digital product is as stable as it is fast."
    }
];
...
const TeamMemberCard: React.FC<TeamMemberCardProps> = ({ member, index }) => {
    ...
    return (
        ...
        >
            <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 border border-white/5 aspect-[4/5] shadow-2xl transition-all duration-500 group-hover:border-cyan-500/30">
                {/* 3D Depth Elements */}
                ...
                {/* Bio Reveal Overlay */}
                <div className="absolute inset-0 bg-cyan-950/95 backdrop-blur-xl p-8 flex flex-col justify-center translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-20">
                ...
                {/* Name & Role Text */}
                <div className="absolute bottom-0 left-0 p-8 w-full z-10 group-hover:translate-y-[-10px] transition-transform duration-500" style={{ transform: "translateZ(30px)" }}>
            ...
            {/* Background Glow */}
            <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-[3rem] blur-3xl opacity-0 group-hover:opacity-10 transition-opacity -z-10"></div>
        </motion.div>
    );
};
...
const AboutPage: React.FC = () => {
  ...
  return (
    <PageWrapper>
      ...
      {/* 5. REDESIGNED TEAM SECTION (UPDATED WITH REAL MEMBERS) */}
      <section className="py-32 bg-slate-950 border-t border-slate-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                  <div className="max-w-2xl">
                      <div className="flex items-center gap-3 mb-6">
                           <span className="px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs font-bold tracking-[0.2em] uppercase">The Lab Specialists</span>
                           <span className="text-slate-500 text-sm font-bold uppercase tracking-widest">{teamMembers.length} Core Architects</span>
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                      ...
                      <div className="flex flex-col items-start pt-2">
                          <p className="text-slate-400 text-lg md:text-xl leading-relaxed mb-10 font-medium max-w-xl">
                              Partner with our elite team to redefine your digital presence. Let's collaborate to transform your boldest ideas into high-performance experiences that dominate the global market.
                          </p>
                          <PremiumButton 
