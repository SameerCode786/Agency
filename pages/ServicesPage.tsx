...
import { CodeIcon, MobileIcon, DesignIcon, SpeedIcon, MaintenanceIcon, StrategyIcon, ArrowRightIcon } from '../components/Icons';
...
const services = [
  ...
  {
    icon: <SpeedIcon className="h-10 w-10 text-cyan-400" />,
  ...
  {
    icon: <MaintenanceIcon className="h-10 w-10 text-cyan-400" />,
  ...
  {
    icon: <StrategyIcon className="h-10 w-10 text-cyan-400" />,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-36">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              key={index}
              className="bg-gray-900/50 p-8 rounded-lg border border-gray-800 hover:border-cyan-400/50 hover:shadow-[0_0_40px_rgba(34,211,238,0.2)] transition-all duration-300 flex flex-col"
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                    {service.tools.map(tool => (
                        <span key={tool} className="text-xs bg-gray-800 text-cyan-300 px-2 py-1 rounded">{tool}</span>
                    ))}
                </div>
              </div>
            </motion.div>
        ...
        <section className="mt-24 py-16 text-center bg-gray-900/50 rounded-lg border border-cyan-500/20">
            <div className="container mx-auto px-4">
                ...
                <Link to="/contact">
                    <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-10 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-bold rounded-full text-lg shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-all duration-300">
                        Schedule a Call
                    </motion.button>
                </Link>
            </div>
